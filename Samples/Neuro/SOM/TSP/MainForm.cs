...
namespace TSP
{
	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		private void generateMapButton_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				citiesCount = Math.Max( 5, Math.Min( 1000, int.Parse( citiesCountBox.Text ) ) );
			}
			catch
			{
				citiesCount = 20;
		...
		private void startButton_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				neurons = Math.Max( 5, Math.Min( 1000, int.Parse( neuronsBox.Text ) ) );
			}
			catch
			{
				neurons = 20;
		...
		void SearchSolution( )
		{
			...
			RefreshDelegate refreshIterationBox = delegate () {
			...
			while ( !needToStop )
			{
				...
				this.Invoke(refreshIterationBox);
